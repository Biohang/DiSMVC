...
parser.add_argument("--h_dim", default=128, type=int, help="dimension of layer h")
parser.add_argument("--z_dim", default=128, type=int, help="dimension of layer z")
...
projection_dis_gene = Projection_dis_gene(args.h_dim, args.z_dim)
projection_dis_miRNA = Projection_dis_miRNA(args.h_dim, args.z_dim)
